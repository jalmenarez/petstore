package cl.jalmenarez.store.gateway.responserewriting;

import static cl.jalmenarez.store.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
